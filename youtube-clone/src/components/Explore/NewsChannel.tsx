...
export const NewsChannel = () => {
    ...
    return(
        <ChannelDescription>
            ...
            <ChannelCategoryBar>
                <ChannelCategoryName>
                    <NavLink to='/explore/news/home' activeClassName='active'>
                        <Name>Home</Name>
                    </NavLink>
                    <NavLink to='/explore/news/channels' activeClassName='active'>
                        <Name>Channels</Name>
                    </NavLink>
                    <NavLink to='/explore/news/about' activeClassName='active'>
                        <Name>About</Name>
                    </NavLink>
                </ChannelCategoryName>
            </ChannelCategoryBar>
