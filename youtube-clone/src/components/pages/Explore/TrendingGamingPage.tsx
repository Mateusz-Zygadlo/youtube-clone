...
import { GamingSectionVideo } from '../../Explore/Trending/Gaming/GamingSectionVideo';
...
export const TrendingGamingPage: React.FC<Props> = ({ openNavFunc, isOpen, isLogin, setMobileWidthFunc, mobileWidth, openNav, minimum, setLoginFunc}) => {
    return(
        <>
            <GlobalStyle />
            <Navbar
